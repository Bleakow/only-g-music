...
const VARIANTS: Record<ButtonVariant, string> = {
  primary:
    "bg-gradient-to-r from-silver-100 to-amethyst-300 text-ink hover:shadow-[0_0_22px_rgba(139,92,246,0.55)]",
  secondary:
...
/**
 * Botón reutilizable del proyecto. Variantes de estilo + estado `loading` con
 * spinner animado (deshabilita el botón mientras carga). Por defecto
 * `type="button"` para evitar envíos accidentales de formularios.
 */
