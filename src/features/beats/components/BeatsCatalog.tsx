 ...
 * compartido (al abrir uno se cierra el que sonaba). Comprar queda cableado
 * visualmente pero INERTE — la venta llega en otro slice.
 */
      ...
      <div className="p-3">
        ...
        <div className="mt-3 flex items-center justify-between gap-2">
          ...
          <button
            type="button"
            disabled
            title={t("beats.comprarPronto")}
            aria-label={`${t("beats.comprar")} — ${t("beats.comprarPronto")}`}
            className="cursor-not-allowed rounded-full border border-white/15 px-3 py-1.5 text-xs tracking-[1px] text-white/40 uppercase"
          >
            {t("beats.comprar")}
          </button>
        </div>
