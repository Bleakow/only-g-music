          ...
          <div className="flex items-center gap-3">
            ...
            {isOwner && (
              <Link
                ...
                className="inline-flex size-9 items-center justify-center rounded-full border border-white/20 text-white/70 transition hover:border-amethyst-300/70 hover:text-white"
              >
          ...
          <div className="mt-6 grid auto-rows-[120px] grid-cols-2 gap-3 sm:auto-rows-[160px] sm:grid-cols-4">
            {profile.gallery.map((item, i) => (
              ...
              >
                <Image
                  src={item.url}
                  alt={t("artistProfile.galleryPhotoAlt", { name: profile.artisticName, n: i + 1 })}
                  fill
