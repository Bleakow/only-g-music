...
/**
 * Loader "vinilo" (portado de Only G Music): un disco con surcos que entra, el
 * brazo baja la aguja (flash de "needle drop") y arranca acelerando hasta girar
 * infinito. Alrededor, un ESPECTRO CIRCULAR de barras que late al beat; encima,
 * un brillo especular fijo y una veta de luz que gira con el disco. Glow + viñeta
 * pulsan al beat. Todo GSAP, dentro de `gsap.context()` + `revert()` (a salvo del
 * doble-montaje de StrictMode). Se muestra durante el handoff SSO Only G → G Notes.
 */
